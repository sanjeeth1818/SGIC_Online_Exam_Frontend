...
2.  Move into the backend directory (it's now a sibling to the frontend):
    ```bash
    cd ../SGIC_Online_Exam_Backend
    ```
...
*   **Port already in use?** If 8080 or 5173 are taken, you can change them in `application.properties` (in the backend folder) or `vite.config.js` (frontend).
